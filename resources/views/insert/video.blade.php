<x-layout>
  <x-slot:tittle></x-slot:tittle>
    ...
    <div style="margin-left: 300px; padding: 20px; width: calc(100% - 300px);">
        <form action="/uploads/insert/video" method="POST" enctype="multipart/form-data" style="display: flex; justify-content: center; align-items: center; height: 100vh; text-align: center;">
          @csrf
            <div>
            ...
            <div style="margin-left: 20px;">
                <input class="form-control" type="text" maxlength="30" name="name_video"  placeholder="name picture" aria-label="default input example"
